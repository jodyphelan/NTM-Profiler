...
def test_fasta_profile():
    run_cmd("ntm-profiler profile -f ~/test_data/ERR459870.contigs.fa -p ERR459870_fasta -t 3")
...
def test_profile():
    run_cmd("ntm-profiler profile -1 ~/test_data/ERR459870_1.fastq.gz -2 ~/test_data/ERR459870_2.fastq.gz -p ERR459870 -t 3")
